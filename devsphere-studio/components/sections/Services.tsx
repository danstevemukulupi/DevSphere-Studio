...
export default function Services() {
  return (
   <>
   {/*<Navbar />*/}
    <div className="flex flex-col items-center justify-center min-h-screen py-1 bg-gray-800">
      <br />
      <br />
      <h1 className="text-5xl font-bold mb-2">My Development Services</h1>
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10  max-w-screen-2xl mx-auto px-2"> 
      <div className="bg-gray-700 rounded-xl shadow-lg p-12 hover:shadow-2xl transition-shadow duration-300
      border border-gray-700 
      hover:border-blue-400 
      hover:shadow-[0_0_15px_rgba(59,130,246,0.8)]
      transition-all 
      duration-300">
        <h2 className="text-2xl font-bold text-white-600 mb-4">
    ...
    <br />
    <br />
    <h4 className="text-2xl font-bold mt-2">Ready to Start Your Project?</h4>
